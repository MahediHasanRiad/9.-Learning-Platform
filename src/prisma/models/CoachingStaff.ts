...
// @ts-nocheck 
/*
 * This file exports the `CoachingStaff` model and its related types.
 *
...
export type GetCoachingStaffAggregateType<T extends CoachingStaffAggregateArgs> = {
      [P in keyof T & keyof AggregateCoachingStaff]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateCoachingStaff[P]>
    : Prisma.GetScalarType<T[P], AggregateCoachingStaff[P]>
}
...
export type GetCoachingStaffGroupByPayload<T extends CoachingStaffGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<CoachingStaffGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof CoachingStaffGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], CoachingStaffGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], CoachingStaffGroupByOutputType[P]>
      }
    >
  >
...
export type CoachingStaffCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<CoachingStaffFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface CoachingStaffDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['CoachingStaff'], meta: { name: 'CoachingStaff' } }
  /**
   ...
   * })
  **/
  count<T extends CoachingStaffCountArgs>(
    args?: Prisma.Subset<T, CoachingStaffCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], CoachingStaffCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends CoachingStaffGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, CoachingStaffGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCoachingStaffGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
